      ...
      <div class="space-y-8">
        ...
        <section>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-6">
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-modern-enhanced hover:shadow-modern-enhanced-dark transition-all duration-300 hover-lift">
        ...
        <section>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-modern-enhanced hover:shadow-modern-enhanced-dark transition-all duration-300 hover-lift">
              ...
              <p class="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">点击"新增"按钮，输入订阅链接（http/https格式），系统会自动解析节点信息。支持多种订阅格式，包括Clash、Surge等。</p>
            </div>
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-modern-enhanced hover:shadow-modern-enhanced-dark transition-all duration-300 hover-lift">
              <div class="flex items-start gap-3 mb-3">
              ...
              <p class="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">在下面生成订阅链接面板选择订阅内容（默认或订阅组），选择输出格式，点击"复制"即可获取订阅链接。</p>
            </div>
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-modern-enhanced hover:shadow-modern-enhanced-dark transition-all duration-300 hover-lift">
              <div class="flex items-start gap-3 mb-3">
              ...
              <p class="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">支持Clash、Surge、Loon、Sing-Box、Base64等多种格式，系统会根据客户端自动选择最佳格式。</p>
            </div>
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-modern-enhanced hover:shadow-modern-enhanced-dark transition-all duration-300 hover-lift">
              <div class="flex items-start gap-3 mb-3">
              ...
              <p class="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">在设置中配置固定的"订阅Token"，建议使用固定Token以确保链接稳定性。</p>
            </div>
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-modern-enhanced hover:shadow-modern-enhanced-dark transition-all duration-300 hover-lift lg:col-span-2">
              <div class="flex items-start gap-3 mb-3">
              ...
              <p class="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">在手动节点管理页面，点击"批量导入"按钮，粘贴节点链接（每行一个），系统会自动解析并导入。</p>
            </div>
          </div>
        </section>
